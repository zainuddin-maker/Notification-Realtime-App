                ...
                r(t, [
                    {
                        key: "encode",
                        value: function (t) {
                            return (t.type !== Et.EVENT && t.type !== Et.ACK) ||
                                !mt(t)
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var e = "" + t.type;
                            return (
                                (t.type !== Et.BINARY_EVENT &&
                                    t.type !== Et.BINARY_ACK) ||
                                    (e += t.attachments + "-"),
                                t.nsp && "/" !== t.nsp && (e += t.nsp + ","),
                                null != t.id && (e += t.id),
                                null != t.data &&
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                if (
                                    n.type === Et.BINARY_EVENT ||
                                    n.type === Et.BINARY_ACK
                                ) {
                                    for (
                                        var r = e + 1;
                ...
                r(i, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return (
                                this.connected &&
                                    this.packet({ type: Et.DISCONNECT }),
                                this.destroy(),
                                this.connected &&
