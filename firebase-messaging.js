        ...
        (function () {
                ...
                return (
                    i &&
                        (i.onupgradeneeded = function (e) {
                            n &&
                                n(new j(i.result, e.oldVersion, i.transaction));
                        }),
                    r.then(function (e) {
                        return new E(e);
                    })
            ...
            m(C, "_index", ["name", "keyPath", "multiEntry", "unique"]),
                ...
                ["openCursor", "openKeyCursor"].forEach(function (o) {
                    [_, C].forEach(function (e) {
                        o in e.prototype &&
                            (e.prototype[o.replace("open", "iterate")] =
                                function () {
                                    var e,
                                        t =
                                            ((e = arguments),
            ...
            function F(e) {
                return {
                    ...
                    requestStatus: 2,
                    expiresIn:
                        ((t = e.expiresIn), Number(t.replace("s", "000"))),
                            ...
                            case 0:
                                return [
                                    ...
                                    he(i, function (e) {
                                        ...
                                        return (
                                            (r = n.registrationPromise),
                                            n.installationEntry
                                        );
                                    }),
                                ];
                            case 1:
                                return (t = e.sent()).fid !== Y
                                    ? [3, 3]
                                    : ((n = {}), [4, r]);
                            case 2:
                                return [
                                    2,
                                    ((n.installationEntry = e.sent()), n),
                                ];
                            case 3:
                                return [
                                    2,
            ...
            function me(e) {
                return he(e, function (e) {
                    ...
                    var t,
                        n = e.authToken;
                    return 1 === (t = n).requestStatus &&
                        t.requestTime + M < Date.now()
            ...
            ((De = Ee = Ee || {}).PUSH_RECEIVED = "push-received"),
                (De.NOTIFICATION_CLICKED = "notification-clicked");
            var Ae = "fcm_token_details_db",
                qe = 5,
            ...
            var Le = "firebase-messaging-database",
                Ve = 1,
                We = "firebase-messaging-store",
                Fe = null;
            function He() {
                return (Fe =
                    Fe ||
                ...
                return v(this, void 0, void 0, function () {
                    ...
                    return g(this, function (e) {
                        switch (e.label) {
                            ...
                            case 3:
                                return [4, Re(i.appConfig.senderId)];
                            case 4:
                                return (r = e.sent()) ? [4, $e(i, r)] : [3, 6];
                            case 5:
                                return e.sent(), [2, r];
                            case 6:
                                return [2];
                        ...
                        switch (e.label) {
                            ...
                            case 4:
                                if ((r = e.sent()).error)
                                    throw (
                                        ((i = r.error.message),
                                        Pe.create("token-unsubscribe-failed", {
                                            errorInfo: i,
                                        }))
                                    );
                                return [3, 6];
            ...
            function Je(e) {
                var t = e.projectId;
                return Ke + "/projects/" + t + "/registrations";
            }
            function Ye(e) {
                var n = e.appConfig,
                    r = e.installations;
            ...
            function Ze(e) {
                ...
                return i !== xe && (o.web.applicationPubKey = i), o;
            }
            function Qe(f, p, d) {
                return v(this, void 0, void 0, function () {
                    var a, u, c, l;
                            ...
                            case 2:
                                return (
                                    ...
                                    (c = {
                                        ...
                                        swScope: p.scope,
                                        endpoint: a.endpoint,
                                        auth: Ne(a.getKey("auth")),
                                        p256dh: Ne(a.getKey("p256dh")),
                                    }),
                                    u ? [3, 3] : [2, et(f, c)]
                                );
                            case 3:
            ...
            function tt(e) {
                return "object" == typeof e && e && Me in e;
            }
            var nt =
                    ...
                    return v(this, void 0, void 0, function () {
                        ...
                        return g(this, function (e) {
                            switch (e.label) {
                                case 0:
                                    return (
                                        this.vapidKey || (this.vapidKey = xe),
                        ...
                        return g(this, function (e) {
                            switch (e.label) {
                                ...
                                case 1:
                                    return (
                                        (t = e.sent()),
                                        [2, Xe(this.firebaseDependencies, t)]
                                    );
                            }
                        });
                    });
                ...
                (rt.prototype.useServiceWorker = function (e) {
                    ...
                    if (this.swRegistration)
                        throw Pe.create("use-sw-after-get-token");
                            ...
                            switch (e.label) {
                                case 0:
                                    return (
                                        (t = (function (e) {
                                            switch (e) {
                                                case Ee.NOTIFICATION_CLICKED:
                                                    return "notification_open";
                                                case Ee.PUSH_RECEIVED:
                            ...
                            switch (e.label) {
                                case 0:
                                    return this.vapidKey
                                        ? [3, 2]
                                        : [4, Ue(this.firebaseDependencies)];
                                case 1:
                                    (t = e.sent()),
                                        (this.vapidKey =
                                            null !==
                        ...
                        return g(this, function (e) {
                            switch (e.label) {
                                ...
                                case 1:
                                    return e.sent(), [2];
                                case 2:
                                    return [4, Ue(this.firebaseDependencies)];
                                case 3:
                                    return (
                                        (t = e.sent()),
                                        [
                    ...
                    return v(this, void 0, void 0, function () {
                        ...
                        return g(this, function (e) {
                            switch (e.label) {
                                ...
                                case 6:
                                    return i
                                        ? ((o = at(Ee.NOTIFICATION_CLICKED, n)),
                                          [2, i.postMessage(o)])
                                        : [2];
                            }
                            var t;
            ...
            lt.INTERNAL.registerComponent(
                new f(
                    ...
                    function (e) {
                        var t = e.getProvider("app").getImmediate(),
                            n = {
                                ...
                                appConfig: (function (e) {
                                    var t, n;
                                    if (!e || !e.options)
                                        throw je("App Configuration Object");
                        ...
                        return new (
                            self && "ServiceWorkerGlobalScope" in self ? it : nt
                        )(n);
                    },
                    "PUBLIC"
                ).setServiceProps(ut)
