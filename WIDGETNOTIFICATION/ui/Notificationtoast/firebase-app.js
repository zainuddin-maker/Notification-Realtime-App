!(function (e, t) {
        ...
        N =
            ...
            (L.prototype.setComponent = function (e) {
                ...
                if (((this.component = e), this.shouldAutoInitialize())) {
                    ...
                    try {
                        for (
                            var r = u(this.instancesDeferred.entries()),
                                i = r.next();
                            !i.done;
                            i = r.next()
                        ) {
            ...
            (L.prototype.initialize = function (e) {
                ...
                try {
                    for (
                        var a = u(this.instancesDeferred.entries()),
                            s = a.next();
                        !s.done;
                        s = a.next()
                    ) {
                        var c = p(s.value, 2),
                            l = c[0],
                            c = c[1];
                        i === this.normalizeInstanceIdentifier(l) &&
                            c.resolve(o);
                    }
                } catch (e) {
                    t = { error: e };
        ...
        var s = {},
            ...
            l = {
                ...
                initializeApp: function (e, t) {
                    ...
                    if (y(s, t))
                        throw B.create("duplicate-app", { appName: t });
                    n = new a(e, n, l);
                    return (s[t] = n);
                },
                app: u,
                ...
                "PUBLIC" === n.type &&
                    ((e = function (e) {
                        if (
                            ...
                            throw B.create("invalid-app-argument", {
                                appName: r,
                            });
                        return e[r]();
                    }),
    ...
    return ee.registerVersion("firebase", "8.4.2", "app"), ee;
});
